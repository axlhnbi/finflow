  ...
  private getDictionary(lang: string) {
    const dict: any = {
      id: {
        ...
        WALLET_LIST: "Daftar Dompet",
        NO_WALLET: "Belum ada dompet ditambahkan.",
        PROFILE: "Profil",
        ...
        REG_ERR_PWD_LENGTH: "Kata sandi minimal 8 karakter!",
      ...
      en: {
        ...
        REG_ERR_PWD_LENGTH: "Password must be at least 8 characters!",
